...
public final class JteindexGenerated {
	...
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, hexlet.code.models.pages.UrlsPage page) {
		...
		gg.jte.generated.ondemand.layout.JtepageGenerated.render(jteOutput, jteHtmlInterceptor, new gg.jte.html.HtmlContent() {
			public void writeTo(gg.jte.html.HtmlTemplateOutput jteOutput) {
				...
				for (var entry : page.getUrls().entrySet()) {
					...
					var __jte_html_attribute_0 = Routes.urlPath(entry.getKey().getId());
	...
	public static void renderMap(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, java.util.Map<String, Object> params) {
		hexlet.code.models.pages.UrlsPage page = (hexlet.code.models.pages.UrlsPage)params.get("page");
