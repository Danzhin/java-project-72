...
import hexlet.code.model.page.Flash;
...
public class UrlsController {
    ...
    public static void readById(Context ctx) throws SQLException {
        ...
        var checks = UrlCheckRepository.readAllWithId(id);
    ...
    private static String prepareName(String name) throws IllegalArgumentException {
